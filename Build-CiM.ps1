...
.DESCRIPTION
  ...
  License secret (pick one — set once, reuse every build):
    ...
    2. $env:CIM_LICENSE_SECRET = '...' in this PowerShell window
...
Write-Host ""
Write-Host "=== Charts In Motion distribution build (single command) ===" -ForegroundColor Cyan

        ...
        "sections": [
            ...
            },
            {
                ...
                "paragraphs": [
                    ...
                    "Update price and volume data — downloads/refreshes OHLCV history used by charts.",
                    "Update indicator snapshots (incremental) — recomputes EMA, MACD, StochRSI, and related snapshot fields used by screener filters and indicator panels.",
                    ...
                    "Refresh share counts (market cap basis) — updates issued share counts used for market-cap calculations (run after splits or periodically).",
            ...
            },
            {
                ...
                "paragraphs": [
                    "The notes icon in the Symbol column opens a per-instrument memo (saved to your account). A filled icon means a note already exists.",
        ...
        "sections": [
            ...
            },
            {
                ...
                "paragraphs": [
                    ...
                    "The notes icon on each row opens a memo for that index. Right-click a row for quick actions such as adding the index to Portfolio or a Watchlist.",
                ],
            },
            {
        ...
        "sections": [
            ...
            },
            {
                ...
                "paragraphs": [
                    ...
                    "Drag ⋮⋮ on a row to set a custom order among your holdings; column-header sort (Symbol, Market Cap, Price, change %) sorts temporarily and turns off Earnings priority until you drag again or re-enable priority.",
        ...
        "sections": [
            ...
            },
            {
                ...
                "paragraphs": [
                    ...
                    "The notes icon opens a per-stock memo. Right-click a row to add the stock to Portfolio or a Watchlist.",
                ],
            },
            {
